...
- Built a **compiler** for the shorthand language deal writers use to describe routes, prices, and conditions: a formal grammar parses it into a typed syntax tree that generates both structured data and the customer-facing deal page text, automating a manual, error-prone formatting step.
